...
//    List<WebElement> pages;
    ...
    public SearchResultsPage checkInterfaces(String name, boolean flag) {
        switch (name) {
            ...
            default:
                Assert.fail("Беспроводной интерфейс с названием '" + name + "' отсутствует на странице");
        }
        return this;
...
//        }
    ...
    public SearchResultsPage filterCheckBox(String filterName, String elementName) {
        ...
        Assert.fail("Чек Бокс " + elementName + " не найден в фильтре " + filterName);
        return this;
    }
